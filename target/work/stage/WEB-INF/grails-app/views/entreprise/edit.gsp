...
<html>
	...
	<body>
		<a href="#edit-entreprise" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-entreprise" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:entrepriseInstance, action:'update']" method="PUT" >
