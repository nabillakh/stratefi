...
printHtmlPart(30)
invokeTag('submitButton','g',59,['name':("Mettre à jour"),'class':("save"),'value':(message(code: 'default.button.create.label', default: 'Create'))],-1)
printHtmlPart(31)
})
...
public static final long LAST_MODIFIED = 1427123586210L
