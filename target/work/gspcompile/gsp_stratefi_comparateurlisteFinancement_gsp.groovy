...
expressionOut.print(request.contextPath)
printHtmlPart(16)
for( _it13201719 in (typeProduit) ) {
changeItVariable(_it13201719)
printHtmlPart(17)
...
printHtmlPart(24)
for( _it19400082 in (secteurs) ) {
changeItVariable(_it19400082)
printHtmlPart(17)
expressionOut.print(it.nomSEO)
printHtmlPart(18)
expressionOut.print(fieldValue(bean: it, field: "nom"))
...
printHtmlPart(27)
for( _it8775712 in (typeProjet) ) {
changeItVariable(_it8775712)
printHtmlPart(17)
expressionOut.print(it.nomSEO)
printHtmlPart(28)
expressionOut.print(fieldValue(bean: it, field: "nom"))
...
public static final long LAST_MODIFIED = 1427123587772L
