...
printHtmlPart(1)
invokeTag('captureMeta','sitemesh',9,['gsp_sm_xmlClosingForEmptyTag':(""),'name':("author"),'content':("Calipolis")],-1)
printHtmlPart(2)
createTagBody(2, {->
...
printHtmlPart(27)
invokeTag('set','g',60,['var':("lien"),'value':(request.contextPath)],-1)
printHtmlPart(28)
}
printHtmlPart(29)
