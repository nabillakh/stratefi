...
invokeTag('eachError','g',26,['bean':(userInstance),'var':("error")],3)
printHtmlPart(19)
})
invokeTag('hasErrors','g',28,['bean':(userInstance)],2)
printHtmlPart(12)
createTagBody(2, {->
printHtmlPart(20)
invokeTag('hiddenField','g',30,['name':("version"),'value':(userInstance?.version)],-1)
printHtmlPart(21)
...
invokeTag('form','g',37,['url':([resource:userInstance, action:'update']),'method':("PUT")],2)
printHtmlPart(24)
})
...
public static final long LAST_MODIFIED = 1425933356457L
