...
printHtmlPart(4)
invokeTag('captureMeta','sitemesh',13,['gsp_sm_xmlClosingForEmptyTag':(""),'name':("author"),'content':("Nabil Lakhmissi")],-1)
printHtmlPart(5)
...
printHtmlPart(22)
invokeTag('set','g',70,['var':("lien"),'value':(request.contextPath)],-1)
printHtmlPart(24)
}
printHtmlPart(25)
...
expressionOut.print(request.contextPath)
printHtmlPart(68)
invokeTag('layoutResources','r',219,[:],-1)
printHtmlPart(20)
})
invokeTag('captureBody','sitemesh',220,['class':("full-width")],1)
printHtmlPart(69)
}
...
public static final long LAST_MODIFIED = 1422446457645L
