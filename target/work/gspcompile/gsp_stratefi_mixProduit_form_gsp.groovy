...
printHtmlPart(3)
expressionOut.print(hasErrors(bean: mixProduitInstance, field: 'formulaire', 'error'))
printHtmlPart(5)
invokeTag('message','g',25,['code':("mixProduit.formulaire.label"),'default':("Formulaire")],-1)
printHtmlPart(6)
invokeTag('select','g',28,['id':("formulaire"),'name':("formulaire.id"),'from':(stratefi.comparateur.Formulaire.list()),'optionKey':("id"),'required':(""),'value':(mixProduitInstance?.formulaire?.id),'class':("many-to-one")],-1)
printHtmlPart(3)
...
public static final long LAST_MODIFIED = 1426775023634L
