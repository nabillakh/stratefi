...
printHtmlPart(17)
if(true && (mixProduitInstance?.niche)) {
printHtmlPart(20)
invokeTag('message','g',46,['code':("mixProduit.niche.label"),'default':("Niche")],-1)
printHtmlPart(21)
createTagBody(3, {->
expressionOut.print(mixProduitInstance?.niche?.encodeAsHTML())
})
invokeTag('link','g',48,['controller':("niche"),'action':("show"),'id':(mixProduitInstance?.niche?.id)],3)
printHtmlPart(16)
}
printHtmlPart(17)
...
public static final long LAST_MODIFIED = 1422011994678L
