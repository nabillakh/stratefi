...
class gsp_stratefi_imagecreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/image/create.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('form','g',35,['url':([resource:imageInstance, action:'save']),'enctype':("multipart/form-data")],2)
printHtmlPart(22)
})
...
public static final long LAST_MODIFIED = 1421759538693L
