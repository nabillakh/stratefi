...
class gsp_stratefi_imagecreateActeur_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/image/createActeur.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(1)
invokeTag('set','g',5,['var':("entityName"),'value':(message(code: 'image.label', default: 'Image'))],-1)
printHtmlPart(1)
createTagBody(2, {->
createTagBody(3, {->
...
invokeTag('form','g',35,['url':([resource:imageInstance, action:'saveActeur']),'enctype':("multipart/form-data")],2)
printHtmlPart(22)
})
...
public static final long LAST_MODIFIED = 1421695037431L
