...
class gsp_stratefi_nichecreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/niche/create.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(1)
invokeTag('set','g',5,['var':("entityName"),'value':(message(code: 'formulaire.label', default: 'Niche'))],-1)
printHtmlPart(1)
createTagBody(2, {->
createTagBody(3, {->
...
public static final long LAST_MODIFIED = 1426773082959L
