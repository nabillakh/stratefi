...
class ReponseController {
    ...
    def save(Reponse reponseInstance) {
        ...
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.created.message', args: [message(code: 'reponseInstance.label', default: 'Reponse'), reponseInstance.id])
    ...
    protected void notFound() {
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.not.found.message', args: [message(code: 'reponseInstance.label', default: 'Reponse'), params.id])
                redirect action: "index", method: "GET"
            }
