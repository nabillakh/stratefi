                    ...
                    <div class="panel-body profile-information">
                       ...
                       <div>
                           <div class="">
                                  ...
                                  Alloratio vous propose ici gratuitement la liste des acteurs qui financent les PME et startup par <strong>${type.nom}</strong>.
    ...
    <div class="panel-body">
                                  <div class="position-center">
                                    <div class="prf-contacts sttng">
                                        <h2 title="${type.nom} PME startup">Moyens de financement par  ${type.nom}</h2>
                                    </div>
