...
<html>
	...
	<body>
		<a href="#edit-produit" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-produit" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:produitInstance, action:'update']" method="PUT" >
